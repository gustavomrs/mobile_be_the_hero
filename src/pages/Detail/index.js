...
export default function Detail() {
  ...
  const message = 'Olá APAD, estou entrando em contato pois gostaria de ajudar no caso com o valor de R$120,00'
  ...
  function sendMail() {
    MailComposer.composeAsync({
      ...
      recipients: ['gustavoufms@gmail.com'],
      body: message
    })
  }

  function sendWhatsapp() {
    Linking.openURL(`whatsapp://send?phone=5567991330700&text=${message}`)
  }
